...
public class CategoryItemsActivity extends AppCompatActivity {
    ...
    private void displayItemCreationDialog(){
        ...
        new AlertDialog.Builder(this).setTitle(R.string.item_dialog_title).setView(itemEditText).setPositiveButton(R.string.positive_button_item, new DialogInterface.OnClickListener() {
            @Override
